...
./UEF2ROM.py -a -B e00 -c e00: -m UEFs/Mega_Games_Cartridge/Orbital-EveryGameGoing.uef ROMs/Orbital.rom
...
./UEF2ROM.py -a -c :6a20/: -m -s UEFs/Mega_Games_Cartridge/Vertigo-EveryGameGoing.uef ROMs/Vertigo-1.rom ROMs/Vertigo-2.rom
...
./UEF2ROM.py -a -B e00 -c :/5800 -m -s UEFs/Mega_Games_Cartridge/Warehouse-fixed.uef ROMs/Warehouse-1.rom ROMs/Warehouse-2.rom
