...
# *MGCROM: CHAIN""
./UEF2ROM.py -w 39f ~/Games/UEFs/games/A-M/AstroPlumber_E.uef ROMs/AstroPlumber.rom

# *MGCROM: CHAIN""
./UEF2ROM.py ~/Games/UEFs/games/A-M/BarBilliards_E.uef ROMs/BarBilliards.rom

# *ROM: CHAIN""
./UEF2ROM.py -m -s ~/Games/UEFs/games/A-M/Boffin2-modified_BE.uef ROMs/Boffin2-1.rom ROMs/Boffin2-2.rom
...
# *ROM: CHAIN""
./UEF2ROM.py -s -m ~/Games/UEFs/games/A-M/BumbleBee_E.uef ROMs/BumbleBee-1.rom ROMs/BumbleBee-2.rom

# *MGCROM: CHAIN""
./UEF2ROM.py -w 880 ~/Games/UEFs/games/A-M/CastleAssault_E.uef ROMs/CastleAssault.rom

# *ROM: CHAIN""
./UEF2ROM.py -s -m ~/Games/UEFs/games/A-M/CastleOfRiddles_E.uef ROMs/CastleOfRiddles-1.rom ROMs/CastleOfRiddles-2.rom

# *MGCROM: CHAIN""
./UEF2ROM.py -w 39f ~/Games/UEFs/games/A-M/CavemanCapers.uef ROMs/CavemanCapers.rom

# *ROM: CHAIN""
./UEF2ROM.py -m ~/Games/UEFs/games/A-M/ChuckieEgg_E.uef ROMs/ChuckieEgg.rom

# *ROM: CHAIN""
./UEF2ROM.py -m -s ~/Games/UEFs/games/A-M/Citadel-PIASRR_E.uef ROMs/Citadel-1.rom ROMs/Citadel-2.rom

# *MGCROM: CHAIN""
./UEF2ROM.py ~/Games/UEFs/games/A-M/CosmicCamouflage_Tape.uef ROMs/CosmicCamouflage-1.rom ROMs/CosmicCamouflage-2.rom

# *ROM: CHAIN""
./UEF2ROM.py -m ~/Games/UEFs/games/A-M/CrazyTracer_E.uef ROMs/CrazyTracer.rom
...
# *ROM: CHAIN""
./UEF2ROM.py -m -s ~/Games/UEFs/games/A-M/Firebug_E.uef ROMs/Firebug-1.rom ROMs/Firebug-2.rom
...
# *ROM: CHAIN""
./UEF2ROM.py -m ~/Games/UEFs/games/A-M/Go_E.uef ROMs/Go.rom

# *MGCROM: CHAIN""
./UEF2ROM.py -w 39f -t ~/Games/UEFs/games/A-M/Guardian_E.uef ROMs/Guardian.rom
...
# *ROM: CHAIN""
./UEF2ROM.py -m ~/Games/UEFs/games/A-M/Maze_E.uef ROMs/Maze.rom

# *MGCROM: CHAIN""
./UEF2ROM.py ~/Games/UEFs/games/A-M/Meteors_E.uef ROMs/Meteors.rom
...
# *ROM: CHAIN""
./UEF2ROM.py -m -s ~/Games/UEFs/games/N-Z/PhilosophersQuest_E.uef ROMs/PhilosophersQuest-1.rom ROMs/PhilosophersQuest-2.rom

# *ROM: CHAIN""
./UEF2ROM.py -m ~/Games/UEFs/games/N-Z/PhilosophersStone_BE.uef ROMs/PhilosophersStone.rom
...
# *ROM: CHAIN""
./UEF2ROM.py -m ~/Games/UEFs/games/N-Z/Snooker-Acornsoft_E.uef ROMs/Snooker.rom

# *MGCROM: CHAIN""
./UEF2ROM.py -t -s ~/Games/UEFs/games/N-Z/SpacemanSid.uef ROMs/SpacemanSid-1.rom ROMs/SpacemanSid-2.rom

# *ROM: CHAIN""
./UEF2ROM.py -s -m ~/Games/UEFs/games/N-Z/SphinxAdventure_E.uef ROMs/SphinxAdventure-1.rom ROMs/SphinxAdventure-2.rom

# *MGCROM: CHAIN""
./UEF2ROM.py ~/Games/UEFs/games/N-Z/StockCar.uef ROMs/StockCar-1.rom ROMs/StockCar-2.rom

# *MGCROM: CHAIN""
./UEF2ROM.py -w 39f -t ~/Games/UEFs/games/N-Z/Stranded_E.uef ROMs/Stranded.rom
...
# *ROM: CHAIN""
./UEF2ROM.py -m -s ~/Games/UEFs/games/N-Z/TwinKingdomValley-modified_E.uef ROMs/TwinKingdomValley-1.rom ROMs/TwinKingdomValley-2.rom

# *MGCROM: CHAIN""
./UEF2ROM.py -s ~/Games/UEFs/games/N-Z/TwelfthNight-Electron.uef ROMs/TwelfthNight-1.rom ROMs/TwelfthNight-2.rom
...
# *ROM: CHAIN""
./UEF2ROM.py -s -m ~/Games/UEFs/games/N-Z/WheelOfFortune_E.uef ROMs/WheelOfFortune-1.rom ROMs/WheelOfFortune-2.rom
