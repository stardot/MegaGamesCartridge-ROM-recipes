...
python3 -c 'open("temp/SCREEN.inf", "w").write("$.CrazeeScr\t48f0\t48f0\t%x" % len(open("temp/SCREEN").read()))'
python3 -c 'import os; os.rename("temp/Game\x84\x7f", "temp/Game"); os.rename("temp/Game\x84\x7f.inf", "temp/Game.inf")'
