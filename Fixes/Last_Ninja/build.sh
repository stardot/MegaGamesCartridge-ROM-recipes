...
#./SSD2UEF.py /tmp/HD-NIN1.ssd UEFs/Mega_Games_Cartridge/LastNinja-EveryGameGoing.uef $.LOADER,$.LOADSCR,$.NINJA-1,$.NINJA-2,$.NINJA-3,1.LEVEL-A,1.LEVEL-B,2.LEVEL-A,2.LEVEL-B,3.LEVEL-A,3.LEVEL-B,4.LEVEL-A,4.LEVEL-B,5.LEVEL-A,5.LEVEL-B,6.LEVEL-A,6.LEVEL-B
cp $1 $2
